...
//   return (
//     <div className="h-[-webkit-available]">
//       {/* Top Summary Cards */}
...
// import WalletHeader from "@/components/earnings/WalletHeader";
import WalletBalanceCard from "@/components/earnings/WalletBalanceCard";
import PerformanceGoals from "@/components/earnings/PerformanceGoals";
import EarningsBreakdown from "@/components/earnings/EarningsBreakdown";
import RecentActivity from "@/components/earnings/RecentActivity";

export default function WalletPage() {
  return (
    <div className="min-h-screen bg-background-light dark:bg-background-dark max-w-md mx-auto">
      {/* <WalletHeader /> */}
