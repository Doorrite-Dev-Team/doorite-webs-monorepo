...
import { ShiftPreferences } from "@/components/account/ShiftPreferences";
import { AccountSettings } from "@/components/account/AccountSettings";
import { LogoutButton } from "@/components/account/LogoutButton";
import { SupportHelp } from "@/components/account/SupportHelp";

export default function ProfilePage() {
  return (
    <main className="bg-background-light dark:bg-background-dark h-[-webkit-available] pb-28">
      {/* <ProfileHeader /> */}
