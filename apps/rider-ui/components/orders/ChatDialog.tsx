...
import { chatApi, type ChatMessage } from "@/libs/api-client";
...
export function ChatDialog({
  ...
  useEffect(() => {
    ...
    const loadMessages = async () => {
      setIsLoading(true);
      const msgs = await chatApi.fetchMessages(orderId);
      setMessages(msgs);
      setIsLoading(false);
    };
  ...
  const isOwnMessage = (msg: ChatMessage) => msg.senderType === "rider";
