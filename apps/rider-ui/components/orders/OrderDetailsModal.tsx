            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <div className="flex items-start justify-between">
                        <div>
                            <DialogTitle className="text-2xl">{order.restaurantName || "Order Details"}</DialogTitle>
                ...
                <div className="space-y-6 py-4">
                    ...
                    <div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                            <p className="text-gray-900 font-medium">{order.customerName || "Customer"}</p>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">{order.pickupLocation.address}</p>
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="flex-1">
                                    <p className="font-semibold text-gray-900">Drop-off Location</p>
                                    <p className="text-sm text-gray-600 mt-1">{order.dropoffLocation.address}</p>
                                    <p className="text-xs text-gray-500 mt-1">
                                        {order.dropoffLocation.lat.toFixed(4)}, {order.dropoffLocation.lng.toFixed(4)}
                                    </p>
                                </div>
                            </div>
                        </div>
