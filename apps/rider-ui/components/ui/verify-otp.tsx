...
interface VerifyOTPProps {
    ...
    // setToSignUp can accept boolean (from signup) or Page (from forgot-password)
    // Casting or union type adjustment might be needed if they conflict, but Page usually handles it.
    // In signup/page.tsx, showOTP is boolean. In forgot-password/form.tsx, page is Page.
    // The hook expects Dispatch<SetStateAction<Page>>.
    // If called from SignUp where setToSignUp is Dispatch<SetStateAction<boolean>>, we might need to adapt.
